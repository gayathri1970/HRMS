  ...
  return (
    <div className="min-h-screen bg-[#F0F2F5] font-sans">
      ...
      <div className="flex">
        ...
        {/* Main Content */}
        <main className="flex-1 p-8 grid grid-cols-1 lg:grid-cols-12 gap-4">
          {/* Left Column */}
                  ...
                  <div className="col-span-2">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {["Single", "Married"].map((status) => (
                        <button key={status} onClick={() => setBasicDetails({...basicDetails, maritalStatus: status})} className={cn("py-2 px-4 rounded-md font-medium text-sm transition-colors", basicDetails.maritalStatus === status ? "bg-[#00AEEF] text-white" : "bg-gray-100 text-gray-700 hover:bg-gray-200")}>
                          {status}
                        </button>
                      ))}
                    </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            {/* About Employee */}
            <Card className="p-6 border-none shadow-sm rounded-xl flex flex-col bg-white">
              <div className="flex items-center justify-between mb-4">
              ...
              {editingAbout ? (
                <div className="space-y-3 flex-1 flex flex-col">
                  <Textarea value={aboutText} onChange={(e) => setAboutText(e.target.value)} placeholder="Write about yourself..." className="flex-1 resize-none" />
                  <Button size="sm" className="bg-[#00AEEF] hover:bg-[#003B5C]" onClick={handleSaveAbout}>Save</Button>
                </div>
              ) : (
            ...
            <Card className="p-6 border-none shadow-sm rounded-xl bg-white">
              ...
              {editingAddress ? (
                <div className="space-y-3">
                  ...
                  <Button size="sm" className="bg-[#00AEEF] hover:bg-[#003B5C]" onClick={handleSaveAddress}>Save</Button>
                </div>
              ) : (
                <div className="grid grid-cols-2 gap-y-3 text-xs">
                  <div className="col-span-2">
          ...
          <div className="lg:col-span-4 flex flex-col gap-4">
            ...
            {/* Passport Details */}
            <Card className="p-6 border-none shadow-sm rounded-xl bg-white">
              <h3 className="font-bold text-gray-800 mb-4">Passport Details</h3>
              <div className="grid grid-cols-2 gap-y-4 text-xs">
                <div>
            ...
            {/* Insurance Policy */}
            <Card className="p-6 border-none shadow-sm rounded-xl bg-white">
              <h3 className="font-bold text-gray-800 mb-4">Insurance / Policy Details</h3>
              <div className="grid grid-cols-2 gap-y-4 text-xs">
                <div>
